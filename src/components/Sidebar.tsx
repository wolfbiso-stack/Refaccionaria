      ...
      >
        ...
        <nav className="mt-4 px-2 space-y-1">
          {[1, 2, 3, 4, 5].map((item) => (
            <div 
              key={item} 
              className="flex items-center px-4 py-3 text-sm font-black text-gray-400 rounded-xl hover:bg-[#fdc401]/10 hover:text-[#997601] transition-all cursor-pointer group"
            >
              <Clock className="mr-3 w-5 h-5 text-gray-300 group-hover:text-[#fdc401] transition-colors" />
