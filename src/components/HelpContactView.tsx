                ...
                <div className="space-y-8">
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm">
                        ...
                        <p className="text-gray-600 font-medium leading-relaxed mb-6">
                            Con más de 40 años de experiencia en el mercado mexicano, Cordobesa Refacciones se ha consolidado como el aliado estratégico para la industria de la construcción y minería. Nuestra especialidad es asegurar que tu equipo nunca se detenga.
                        </p>
