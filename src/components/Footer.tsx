        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              Cordobesa Refacciones es una empresa de refacciones para maquinaria pesada con más de 10 años de experiencia, agrícola e industrial, al servicio de toda la zona y sus alrededores.
            </p>
          </div>
